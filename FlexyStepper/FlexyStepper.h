...
class FlexyStepper
{
  public:
    ...
    // public functions
    //
    FlexyStepper(PinName stepPinNumber, PinName directionPinNumber);
    ...
    bool moveToHomeInSteps(long directionTowardHome, float speedInStepsPerSecond, long maxDistanceToMoveInSteps, PinName homeLimitSwitchPinName);
    bool moveToHomeInStepsInvert(long directionTowardHome, float speedInStepsPerSecond, long maxDistanceToMoveInSteps, PinName homeLimitSwitchPinName);
